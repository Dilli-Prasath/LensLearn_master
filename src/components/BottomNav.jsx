      ...
      <div style={styles.navInner}>
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              {isScan ? (
                <div style={{ ...styles.scanBtn, ...(isActive ? styles.scanBtnActive : {}) }}>
                  <Icon size={20} />
...
const styles = {
  nav: {
    ...
    zIndex: 50, boxShadow: '0 -2px 20px rgba(0, 0, 0, 0.3)',
  },
  topBorder: {
    height: 1,
  ...
  navInner: {
    ...
    maxWidth: 'var(--layout-max-width, 1200px)', margin: '0 auto',
    paddingBottom: 'env(safe-area-inset-bottom, 0px)',
  },
  navItem: {
    display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
    gap: 4, padding: '6px 10px', background: 'none', border: 'none',
    color: 'var(--text-muted)', cursor: 'pointer', fontSize: 11, fontWeight: 500,
    transition: 'color 0.2s', position: 'relative', flex: 1,
  },
  ...
  glowDot: {
    ...
    background: 'var(--primary-light)', boxShadow: '0 0 8px rgba(99,102,241,0.6)',
  },
  scanBtn: {
    width: 42, height: 42, borderRadius: 13,
    background: 'rgba(30,41,59,0.6)', border: '1.5px solid rgba(99,102,241,0.2)',
  ...
  scanBtnActive: {
    ...
    borderColor: 'var(--primary)', color: 'white', transform: 'scale(1.08)',
    boxShadow: '0 4px 16px rgba(99,102,241,0.4)',
  },
  scanRing: {
    position: 'absolute', inset: -5, border: '1.5px dashed rgba(99,102,241,0.3)',
    borderRadius: 17, pointerEvents: 'none',
  },
